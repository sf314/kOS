...
function burnTimeFromDV {
    ...
    local force is ship:maxthrust * 1000. // He used single engine, I use full stage
    local m is ship:mass * 1000. // Starting mass in kg.
    local e is constant():E. // const.
    local imp is firstEngine:isp. // first engine specific impulse in sec.
    local g is 9.80665. //
    print "force is " + force.
    print "m is " + m.
    print "imp is " + imp.
    local result is g * m * imp * (1 - e^(-dV / (g * imp))) / force.
    return result.
